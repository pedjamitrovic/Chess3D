...
{
    public enum Piece { None, WhitePawn, WhiteRook, WhiteKnight, WhiteBishop, WhiteQueen, WhiteKing, BlackPawn, BlackRook, BlackKnight, BlackBishop, BlackQueen, BlackKing };
    ...
    public enum Square
    {
        ...
        A8 = 91, B8, C8, D8, E8, F8, G8, H8, OffLimits
    };
